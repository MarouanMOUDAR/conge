...
public class EmployeeController implements Serializable {
    ...
    public void findChefEntiteAdministrative() {
        chefs = ejbFacade.findChefEntiteAdministrative();
    }

    public EmployeeController() {
    }

    public EmployeeFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(EmployeeFacade ejbFacade) {
